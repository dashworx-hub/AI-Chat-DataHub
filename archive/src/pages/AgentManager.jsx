...
import { Search, RefreshCw, Plus, Eye, Edit, Trash2, Copy, Save, X, FileText, Bot, ChevronRight, Clock, Cloud } from 'lucide-react';
                      ...
                      return (
                        <div
                          ...
                          className={`group relative p-4 border rounded-xl cursor-pointer transition-all duration-200 fade-in ${
                            isSelected
                              ? 'border-[#177091] bg-blue-50 shadow-sm'
              ...
              <div className="card-header flex-shrink-0">
                <div className="flex items-center justify-between">
                  ...
                  <div className="status-indicator">
                    {isBusy ? (
                      <Spinner size="sm" className="text-[#177091]" />
                    ) : (
                      ...
                      <div className="flex items-center justify-between mb-4">
                        <div>
                          ...
                          <p className="text-hint">
                            Edit your instructions only. Guard rails are appended automatically and cannot be edited.
                          </p>
                          {lastUpdated && (
