        ...
        <form onSubmit={handleSubmit} className="px-6 py-4">
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#177091] focus:border-transparent text-gray-900 placeholder-gray-400 font-mono"
