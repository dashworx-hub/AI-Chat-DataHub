        ...
        <form onSubmit={handleSubmit} className="px-6 py-4">
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#177091] focus:border-transparent text-gray-900 placeholder-gray-400"
          ...
          <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-200">
            ...
            <button
              type="submit"
              disabled={!label.trim()}
              className="px-4 py-2 text-sm font-medium text-white bg-[#177091] rounded-lg hover:bg-[#155a75] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Save
            </button>
          </div>
